...
public class TennisPlayerApplication implements CommandLineRunner {
	...
	public void run(String...args)throws  Exception{
		logger.info("\n\n>>Inserting Player: {}", repo.save(new Player("Roger Federer", "Swiss", Date.valueOf("1981-08-08"), 103)));
		...
		logger.info("\n\n>>Querying Player with id=2: {}", repo.findById(2));
		...
		logger.info("\n\n >> All Players: {}",repo.findAll());

		logger.info("\n\n >> Players from Austria: {}", repo.findByNationality("Austria"));
	}
